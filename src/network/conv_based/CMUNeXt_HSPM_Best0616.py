...
class CMUNeXt_HSPM_Best0616(nn.Module):
    def __init__(
        self,
        input_channel=3,
        num_classes=1,
        ...
        super().__init__()
        if num_classes != 1:
            raise ValueError("CMUNeXt_HSPM_Best0616 supports binary segmentation only.")
