...
def cmunext_ba_dualgag_speckleenhance(
    input_channel=3,
    num_classes=1,
    ddsr_stages=(0, 1),
    gag_stages=(2, 3),
...
def cmunext_ba_dualgag_speckleenhance_full(input_channel=3, num_classes=1):
    return CMUNeXt_BA_DualGAG_SpeckleEnhance(
        input_channel=input_channel,
        num_classes=num_classes,
        dims=(16, 32, 128, 160, 256),
...
def cmunext_ba_dualgag_speckleenhance_s(
    input_channel=3,
    num_classes=1,
    ddsr_stages=(0, 1),
    gag_stages=(2, 3),
...
def cmunext_ba_dualgag_speckleenhance_l(
    input_channel=3,
    num_classes=1,
    ddsr_stages=(0, 1),
    gag_stages=(2, 3),
